...
## Project Structure
    ...
    ├── samplescarapp_dev_32549  # Django project configurations
...
1. Clone this repo and `cd samplescarapp_dev_32549`
...
2. Clone this repo and `cd samplescarapp_dev_32549`
